...
O.push("1. EDGE GAP — drawn surface/shoulder edge vs natural terrain beneath (AFTER items 2-4,8)")
...
O.push("")
O.push("4. BRIDGE HANDOFF (AFTER items 2-4,8) — biggest walkable-surface step near each span")
{
...
O.push("")
O.push("5. FLOATING PROPS — base sitting above the surface beneath it (AFTER items 2-4,8)")
{
  const rows = []
