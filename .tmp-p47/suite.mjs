...
O.push("1. EDGE GAP — drawn surface/shoulder edge vs natural terrain beneath (AFTER terrain grading)")
...
O.push("")
O.push("4. BRIDGE HANDOFF (AFTER terrain grading) — biggest walkable-surface step near each span")
{
...
O.push("")
O.push("5. FLOATING PROPS — base sitting above the surface beneath it (AFTER terrain grading)")
{
  const rows = []
