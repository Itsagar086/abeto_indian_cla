...
O.push("1. EDGE GAP — drawn surface/shoulder edge vs natural terrain beneath (AFTER 2,3,4,6,8)")
...
O.push("")
O.push("4. BRIDGE HANDOFF (AFTER 2,3,4,6,8) — biggest walkable-surface step near each span")
{
...
O.push("")
O.push("5. FLOATING PROPS — base sitting above the surface beneath it (AFTER 2,3,4,6,8)")
{
  const rows = []
